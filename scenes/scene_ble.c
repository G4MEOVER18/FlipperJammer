...
/* BLE Run screen — entered from Duration scene */
...
static void ble_run_update_widget(JammerApp* app) {
    ...
    widget_add_string_element(app->widget,  2, 18, AlignLeft,   AlignTop, FontSecondary, "Kanaele: 37 / 38 / 39");
    widget_add_string_element(app->widget,  2, 30, AlignLeft,   AlignTop, FontSecondary, "NRF24 BLE Adv Flood");
